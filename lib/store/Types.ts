...
export type PageStateFunction<T, E extends PageState<T> = PageState<T>> = () => E
// Type which defines pagination actions in a module
export type PageActionTree<T, E extends PageState<T> = PageState<T>> = ActionTree<E, RootState>
// Defines getters in a paginated module
export type PageGetterTree<T, E extends PageState<T> = PageState<T>> = GetterTree<E, RootState>
// Defines mutations inside a module
export type PageMutationTree<T, E extends PageState<T> = PageState<T>> = MutationTree<E>
